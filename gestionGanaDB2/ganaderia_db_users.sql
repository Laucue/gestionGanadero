...
CREATE TABLE `users` (
  ...
  `FullName` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  CONSTRAINT `FK_Users_Roles_IdRole` FOREIGN KEY (`IdRole`) REFERENCES `roles` (`IdRole`)
...
INSERT INTO `users` VALUES (1,'Valeria Sanchez','valeriasanchezdrive@gmail.com','3136312657','1234',NULL,'2025-11-23 20:44:45.626399');
