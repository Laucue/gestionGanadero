...
CREATE TABLE `auditlogs` (
  ...
  `Entity` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `EntityId` int NOT NULL,
  `Timestamp` datetime(6) NOT NULL,
  `Details` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`IdAudit`),
  KEY `IX_AuditLogs_IdUser` (`IdUser`),
  CONSTRAINT `FK_AuditLogs_Users_IdUser` FOREIGN KEY (`IdUser`) REFERENCES `users` (`IdUser`)
