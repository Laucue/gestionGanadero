...
CREATE TABLE `sales` (
  ...
  `BuyerName` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  PRIMARY KEY (`IdSale`),
  KEY `IX_Sales_IdAnimal` (`IdAnimal`),
  CONSTRAINT `FK_Sales_Animals_IdAnimal` FOREIGN KEY (`IdAnimal`) REFERENCES `animals` (`IdAnimal`) ON DELETE CASCADE
