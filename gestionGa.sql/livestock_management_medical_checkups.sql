...
CREATE TABLE `medical_checkups` (
  ...
  `checkup_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `findings` text COLLATE utf8mb4_unicode_ci,
  `status` enum('Programado','Completado','Cancelado') COLLATE utf8mb4_unicode_ci DEFAULT 'Programado',
  ...
  CONSTRAINT `medical_checkups_ibfk_1` FOREIGN KEY (`health_record_id`) REFERENCES `health_records` (`health_record_id`) ON DELETE CASCADE
